...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2024 at 05:45 AM
...
CREATE TABLE `employee_emergency` (
  `employee_emergency_id` int(11) NOT NULL,
  `employee_id` int(11) NOT NULL,
...
CREATE TABLE `employee_immigration` (
  `employee_immigration_id` int(11) NOT NULL,
  `employee_id` int(11) NOT NULL,
  `visa_type` varchar(255) DEFAULT NULL,
  `passport_number` int(11) DEFAULT NULL,
  `passport_valid_from` int(11) DEFAULT NULL,
  `passport_valid_to` int(11) DEFAULT NULL,
  `brp_number` int(11) DEFAULT NULL,
  `brp_valid_from` int(11) DEFAULT NULL,
  `brp_valid_to` int(11) DEFAULT NULL,
  `status_letter` int(11) DEFAULT NULL,
  `share_code` int(11) DEFAULT NULL,
  `ecs_report` int(11) DEFAULT NULL,
  `reminder_duration` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `employee_emergency`
  ADD PRIMARY KEY (`employee_emergency_id`);

--
-- Indexes for table `employee_immigration`
--
ALTER TABLE `employee_immigration`
  ADD PRIMARY KEY (`employee_immigration_id`);
...
--
ALTER TABLE `employee_emergency`
  MODIFY `employee_emergency_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `employee_immigration`
--
ALTER TABLE `employee_immigration`
  MODIFY `employee_immigration_id` int(11) NOT NULL AUTO_INCREMENT;
